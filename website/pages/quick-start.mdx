...
<Steps>
    ...
    Describe the object you want to generate with GPTyped using Zod. In this example, we want to generate tweets.
    ...
    *Note: replace `YOUR_OPEN_AI_SECRET_KEY` with your actual OpenAI key.*
