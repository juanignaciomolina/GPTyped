...
<div style={{ display: "flex" }}>
  <div style={{ padding: "5px" }}>![npm Version](https://img.shields.io/npm/v/gptyped)</div>
  <div style={{ padding: "5px" }}>![bundlesize](https://img.shields.io/bundlephobia/min/gptyped)</div>
  <div style={{ padding: "5px" }}>![MIT License](https://img.shields.io/npm/l/gptyped)</div>
</div>
...
You can install GPTyped using NPM, PNPM or Yarn:
