...
It doesn't handle the communication with the AI or is even aware of which AI is being used. For this objective, it relies on a `client` to send the prompt and receive the response.
